...
define i32 @values_interpolator(i32 %index) {
entry:
  %x1 = mul i32 1, %index
  %x2 = mul i32 %x1, %index
  %x3 = mul i32 %x2, %index
  ...
  %d5 = mul i32 0, %x5
  %sum1 = add i32 0, %d1
  %sum2 = add i32 %sum1, %d2
  %sum3 = add i32 %sum2, %d3
  %sum4 = add i32 %sum3, %d4
  %sum5 = add i32 %sum4, %d5
  ret i32 %sum5
}

define i32 @array2_interpolator(i32 %index) {
entry:
  %x1 = mul i32 1, %index
  %x2 = mul i32 %x1, %index
  %x3 = mul i32 %x2, %index
